...
public class LoadCarrierManagement extends AbstractLeafMenu implements IBrowsable<ILoadCarrier<IDeliverable>> {
    @Override
            ...
            car.ifPresentOrElse(
                    rCar -> {
                        ...
                        System.out.println("Enter" +
                                ...
                                "\n4 to perform extra actions (emergency procedures etc)");
